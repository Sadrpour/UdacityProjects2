      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::VectorXd ptsxx(6);
          Eigen::VectorXd ptsyy(6);
          ptsxx << ptsx_local[0],ptsx_local[1],ptsx_local[2],ptsx_local[3],ptsx_local[4],ptsx_local[5];
          ptsyy << ptsy_local[0],ptsy_local[1],ptsy_local[2],ptsy_local[3],ptsy_local[4],ptsy_local[5];

          auto coeffs = polyfit(ptsxx, ptsyy,3);
          // TODO: calculate the cross track error
          //double cte =  polyeval(coeffs, ptsx[0]) - ptsy[0];
          ...
          // std::cout << "projected " << mpc_y_vals[0] << mpc_y_vals[1]  << mpc_y_vals[2] << std::endl;
        ...
        // yellow line is drawn by what we want based on code below:
          double poly_inc = 2.5;
          int num_points = 25;
